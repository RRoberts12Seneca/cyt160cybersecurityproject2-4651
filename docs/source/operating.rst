[cyt160cybersecurityproject2-4651] Operating Details
====================================

Generated On: 2024-11-11 20:03:48 UTC
...
.. important::
   ...
   **not be valid if your [cyt160cybersecurityproject2-4651] container is NOT running**.

.. tip::
   You must have your [cyt160cybersecurityproject2-4651] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/Rroberts12Seneca/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/RRoberts12Seneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46829  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Rroberts12Seneca'  \-\-env DOCKERUSERNAME='rroberts87'  \-\-env MQTTUSERNAME='rroberts87'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   rroberts87/cyt160cybersecurityproject2-4651-amd64 (https://hub.docker.com/r/rroberts87/cyt160cybersecurityproject2-4651-amd64)
...
.. important::
   docker run -d -p 47531:47531 -p 49271:49271 -p 53683:53683 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=cyt160cybersecurityproject2-4651 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cyt160cybersecurityproject2-4651 \-\-env GITUSERNAME=Rroberts12Seneca  \-\-env GITREPOURL=https://github.com/RRoberts12Seneca/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=47531  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=49271  \-\-env SOLUTIONVIPERVIZPORT=53683 \-\-env DOCKERUSERNAME='rroberts87' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=46829 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='rroberts87' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  rroberts87/cyt160cybersecurityproject2-4651-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=53683
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=47531
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - rroberts87/cyt160cybersecurityproject2-4651-amd64
...
It can be accessed by entering: http://localhost:49271
...
.. important::
   http://localhost:53683/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:53683/<html file>
...
[cyt160cybersecurityproject2-4651] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Rroberts12Seneca/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cyt160cybersecurityproject2-4651
...
.. important::
   https://cyt160cybersecurityproject2-4651.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cyt160cybersecurityproject2-4651
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=47531, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45605, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=34585, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=32885, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=37361, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45745, HPDEHOST=127.0.1.1, HPDEPORT=46279, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35829

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5609-cyt160cybersecurityproject2-4651,solution_preprocessing_ai_mqtt_dag-cyt160cybersecurityproject2-4651, python-preprocess-1877-cyt160cybersecurityproject2-4651,solution_preprocessing_ai_mqtt_dag-cyt160cybersecurityproject2-4651, python-ai-1759-cyt160cybersecurityproject2-4651,solution_preprocessing_ai_mqtt_dag-cyt160cybersecurityproject2-4651, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
