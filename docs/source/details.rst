[cyt160cybersecurityproject2-4651] Details
============================
...
.. list-table::
   ...
   * - **User Parameter**
     - **Chosen Value**
   * - solutionname
     - cyt160cybersecurityproject2-4651
   * - solutiontitle
     - My Solution Title
   * - solutiondescription
...
.. list-table::
   ...
   * - preprocess_data_topic
     - cisco-network-preprocess,iot-preprocess2
   * - ml_data_topic
     - ml-data
...
.. list-table::
   ...
   * - vipervizport
     - 9005
   * - topic
     - cisco-network-preprocess,iot-cisco-network-privategpt
   * - dashboardhtml
     - --dashboardhtml--
   * - secure
     - 1
